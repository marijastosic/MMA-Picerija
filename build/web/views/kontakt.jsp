...
<center>
    ...
    <br>
    <img src="<c:url value="/images/marija.jpg"/>" style="width: 170px; height: 170px;"class="rounded float-left"/>
    ...
    <hr>
    <img src="<c:url value="/images/ana.PNG"/>" style="width: 170px; height: 170px;"class="rounded"/>
    <h3>Ana Đokić <br></h3>
    ...
    <hr>
    <img src="<c:url value="/images/milica.PNG"/>" style="width: 170px; height: 170px;"class="rounded float-right"/>
