...
@NamedQueries({
    ...
    , @NamedQuery(name = "Pica.findById", query = "SELECT p FROM Pica p WHERE p.id = :id")
    , @NamedQuery(name = "Pica.findByNaziv", query = "SELECT p FROM Pica p WHERE p.naziv = :naziv")
    , @NamedQuery(name = "Pica.findByOpis", query = "SELECT p FROM Pica p WHERE p.opis = :opis")
    , @NamedQuery(name = "Pica.findBySastojci", query = "SELECT p FROM Pica p WHERE p.sastojci = :sastojci")
    , @NamedQuery(name = "Pica.findByCena", query = "SELECT p FROM Pica p WHERE p.cena = :cena")
    , @NamedQuery(name = "Pica.findByTezina", query = "SELECT p FROM Pica p WHERE p.tezina = :tezina")
    , @NamedQuery(name = "Pica.findByOcena", query = "SELECT p FROM Pica p WHERE p.ocena = :ocena")
    , @NamedQuery(name = "Pica.findByAktivna", query = "SELECT p FROM Pica p WHERE p.aktivna = :aktivna")
    , @NamedQuery(name = "Pica.findBySlikaUrl", query = "SELECT p FROM Pica p WHERE p.slikaUrl = :slikaUrl")})
