...
@NamedQueries({
    ...
    , @NamedQuery(name = "Porudzbina.findByIsporucena", query = "SELECT p FROM Porudzbina p WHERE p.isporucena = :isporucena")
    , @NamedQuery(name = "Porudzbina.findByPlaceno", query = "SELECT p FROM Porudzbina p WHERE p.placeno = :placeno")
