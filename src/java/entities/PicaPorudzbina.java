...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "PicaPorudzbina.findAll", query = "SELECT p FROM PicaPorudzbina p")
    , @NamedQuery(name = "PicaPorudzbina.findById", query = "SELECT p FROM PicaPorudzbina p WHERE p.id = :id")
    , @NamedQuery(name = "PicaPorudzbina.findByKolicina", query = "SELECT p FROM PicaPorudzbina p WHERE p.kolicina = :kolicina")})
